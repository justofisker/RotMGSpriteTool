...
impl<'a> SpriteSheet<'a> {
    ...
    pub fn sprite_sheet_name(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<&str>>(SpriteSheet::VT_SPRITE_SHEET_NAME, None)
        }
    }
    #[inline]
    pub fn atlas_id(&self) -> u64 {
        ...
        unsafe {
            self._tab
                .get::<u64>(SpriteSheet::VT_ATLAS_ID, Some(0))
                .unwrap()
        }
    }
    #[inline]
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> SpriteSheetBuilder<'a, 'b, A> {
    ...
    pub fn add_sprite_sheet_name(&mut self, sprite_sheet_name: flatbuffers::WIPOffset<&'b str>) {
        self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
            SpriteSheet::VT_SPRITE_SHEET_NAME,
            sprite_sheet_name,
        );
    }
    #[inline]
    pub fn add_atlas_id(&mut self, atlas_id: u64) {
        self.fbb_
            .push_slot::<u64>(SpriteSheet::VT_ATLAS_ID, atlas_id, 0);
    }
    #[inline]
    pub fn add_sprites(
        &mut self,
...
impl<'a> AnimatedSprite<'a> {
    ...
    pub fn sprite_sheet_name(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(
                AnimatedSprite::VT_SPRITE_SHEET_NAME,
                None,
            )
        }
    }
    ...
    pub fn index(&self) -> u16 {
        ...
        unsafe {
            self._tab
                .get::<u16>(AnimatedSprite::VT_INDEX, Some(0))
                .unwrap()
        }
    }
    #[inline]
    pub fn set(&self) -> u16 {
        ...
        unsafe {
            self._tab
                .get::<u16>(AnimatedSprite::VT_SET, Some(0))
                .unwrap()
        }
    }
    #[inline]
    pub fn direction(&self) -> u16 {
        ...
        unsafe {
            self._tab
                .get::<u16>(AnimatedSprite::VT_DIRECTION, Some(0))
                .unwrap()
        }
    }
    #[inline]
    pub fn action(&self) -> u16 {
        ...
        unsafe {
            self._tab
                .get::<u16>(AnimatedSprite::VT_ACTION, Some(0))
                .unwrap()
        }
    }
    #[inline]
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> AnimatedSpriteBuilder<'a, 'b, A> {
    ...
    pub fn add_index(&mut self, index: u16) {
        self.fbb_
            .push_slot::<u16>(AnimatedSprite::VT_INDEX, index, 0);
    }
    #[inline]
    ...
    pub fn add_direction(&mut self, direction: u16) {
        self.fbb_
            .push_slot::<u16>(AnimatedSprite::VT_DIRECTION, direction, 0);
    }
    #[inline]
    pub fn add_action(&mut self, action: u16) {
        self.fbb_
            .push_slot::<u16>(AnimatedSprite::VT_ACTION, action, 0);
    }
    #[inline]
