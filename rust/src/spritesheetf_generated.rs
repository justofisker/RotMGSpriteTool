...
impl<'b> flatbuffers::Push for Position {
    ...
    unsafe fn push(&self, dst: &mut [u8], _written_len: usize) {
        let src = ::core::slice::from_raw_parts(self as *const Position as *const u8, Self::size());
...
impl<'a> Sprite<'a> {
  ...
  pub const VT_A_ID: flatbuffers::VOffsetT = 18;
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
    ...
    builder.add_a_id(args.a_id);
    if let Some(x) = args.sprite_sheet_name { builder.add_sprite_sheet_name(x); }
    if let Some(x) = args.most_common_color { builder.add_most_common_color(x); }
    if let Some(x) = args.mask_position { builder.add_mask_position(x); }
  ...
  pub fn padding(&self) -> u16 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u16>(Sprite::VT_PADDING, Some(0)).unwrap()}
  }
  #[inline]
  pub fn index(&self) -> u16 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u16>(Sprite::VT_INDEX, Some(0)).unwrap()}
  }
  #[inline]
  ...
  pub fn sprite_sheet_name(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(Sprite::VT_SPRITE_SHEET_NAME, None)}
  }
  #[inline]
  pub fn a_id(&self) -> u64 {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u64>(Sprite::VT_A_ID, Some(0)).unwrap()}
  }
}
...
impl flatbuffers::Verifiable for Sprite<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("sprite_sheet_name", Self::VT_SPRITE_SHEET_NAME, false)?
     .visit_field::<u64>("a_id", Self::VT_A_ID, false)?
     .finish();
    Ok(())
  }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> SpriteBuilder<'a, 'b, A> {
  ...
  pub fn add_position(&mut self, position: &Position) {
    self.fbb_.push_slot_always::<&Position>(Sprite::VT_POSITION, position);
  }
  #[inline]
  pub fn add_mask_position(&mut self, mask_position: &Position) {
    self.fbb_.push_slot_always::<&Position>(Sprite::VT_MASK_POSITION, mask_position);
  }
  #[inline]
  pub fn add_padding(&mut self, padding: u16) {
    self.fbb_.push_slot::<u16>(Sprite::VT_PADDING, padding, 0);
  }
  #[inline]
  pub fn add_index(&mut self, index: u16) {
    self.fbb_.push_slot::<u16>(Sprite::VT_INDEX, index, 0);
  }
  #[inline]
  pub fn add_most_common_color(&mut self, most_common_color: &Color) {
    self.fbb_.push_slot_always::<&Color>(Sprite::VT_MOST_COMMON_COLOR, most_common_color);
  }
  #[inline]
  ...
  pub fn add_sprite_sheet_name(&mut self, sprite_sheet_name: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Sprite::VT_SPRITE_SHEET_NAME, sprite_sheet_name);
  }
  #[inline]
  pub fn add_a_id(&mut self, a_id: u64) {
    self.fbb_.push_slot::<u64>(Sprite::VT_A_ID, a_id, 0);
  }
  #[inline]
...
impl<'a> SpriteSheet<'a> {
  pub const VT_SPRITE_SHEET_NAME: flatbuffers::VOffsetT = 4;
  ...
  pub fn sprite_sheet_name(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(SpriteSheet::VT_SPRITE_SHEET_NAME, None)}
  }
  #[inline]
  pub fn atlas_id(&self) -> u64 {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u64>(SpriteSheet::VT_ATLAS_ID, Some(0)).unwrap()}
  }
  #[inline]
  pub fn sprites(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Sprite<'a>>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Sprite>>>>(SpriteSheet::VT_SPRITES, None)}
  }
}
...
impl flatbuffers::Verifiable for SpriteSheet<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("sprite_sheet_name", Self::VT_SPRITE_SHEET_NAME, false)?
     .visit_field::<u64>("atlas_id", Self::VT_ATLAS_ID, false)?
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> SpriteSheetBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_sprite_sheet_name(&mut self, sprite_sheet_name: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(SpriteSheet::VT_SPRITE_SHEET_NAME, sprite_sheet_name);
  }
  #[inline]
  pub fn add_atlas_id(&mut self, atlas_id: u64) {
    self.fbb_.push_slot::<u64>(SpriteSheet::VT_ATLAS_ID, atlas_id, 0);
  }
  #[inline]
  pub fn add_sprites(&mut self, sprites: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<Sprite<'b >>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(SpriteSheet::VT_SPRITES, sprites);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> SpriteSheetBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
    SpriteSheetBuilder {
      fbb_: _fbb,
      start_: start,
...
impl<'a> AnimatedSprite<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.sprite { builder.add_sprite(x); }
    if let Some(x) = args.sprite_sheet_name { builder.add_sprite_sheet_name(x); }
  ...
  pub fn sprite_sheet_name(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(AnimatedSprite::VT_SPRITE_SHEET_NAME, None)}
  }
  #[inline]
  pub fn index(&self) -> u16 {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u16>(AnimatedSprite::VT_INDEX, Some(0)).unwrap()}
  }
  #[inline]
  pub fn set(&self) -> u16 {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u16>(AnimatedSprite::VT_SET, Some(0)).unwrap()}
  }
  #[inline]
  pub fn direction(&self) -> u16 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u16>(AnimatedSprite::VT_DIRECTION, Some(0)).unwrap()}
  }
  #[inline]
  pub fn action(&self) -> u16 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u16>(AnimatedSprite::VT_ACTION, Some(0)).unwrap()}
  }
  #[inline]
  pub fn sprite(&self) -> Option<Sprite<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<Sprite>>(AnimatedSprite::VT_SPRITE, None)}
  }
}
...
impl flatbuffers::Verifiable for AnimatedSprite<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("sprite_sheet_name", Self::VT_SPRITE_SHEET_NAME, false)?
     .visit_field::<u16>("index", Self::VT_INDEX, false)?
     .visit_field::<u16>("set", Self::VT_SET, false)?
     .visit_field::<u16>("direction", Self::VT_DIRECTION, false)?
     .visit_field::<u16>("action", Self::VT_ACTION, false)?
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> AnimatedSpriteBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_sprite_sheet_name(&mut self, sprite_sheet_name: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(AnimatedSprite::VT_SPRITE_SHEET_NAME, sprite_sheet_name);
  }
  #[inline]
  pub fn add_index(&mut self, index: u16) {
    self.fbb_.push_slot::<u16>(AnimatedSprite::VT_INDEX, index, 0);
  }
  #[inline]
  pub fn add_set(&mut self, set: u16) {
    self.fbb_.push_slot::<u16>(AnimatedSprite::VT_SET, set, 0);
  }
  #[inline]
  pub fn add_direction(&mut self, direction: u16) {
    self.fbb_.push_slot::<u16>(AnimatedSprite::VT_DIRECTION, direction, 0);
  }
  #[inline]
  pub fn add_action(&mut self, action: u16) {
    self.fbb_.push_slot::<u16>(AnimatedSprite::VT_ACTION, action, 0);
  }
  #[inline]
  pub fn add_sprite(&mut self, sprite: flatbuffers::WIPOffset<Sprite<'b >>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<Sprite>>(AnimatedSprite::VT_SPRITE, sprite);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> AnimatedSpriteBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
impl<'a> SpriteSheetRoot<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.animated_sprites { builder.add_animated_sprites(x); }
    if let Some(x) = args.sprites { builder.add_sprites(x); }
    builder.finish()
  }
  ...
  #[inline]
  pub fn sprites(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<SpriteSheet<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<SpriteSheet>>>>(SpriteSheetRoot::VT_SPRITES, None)}
  }
  #[inline]
  pub fn animated_sprites(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<AnimatedSprite<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<AnimatedSprite>>>>(SpriteSheetRoot::VT_ANIMATED_SPRITES, None)}
  }
}
...
impl flatbuffers::Verifiable for SpriteSheetRoot<'_> {
  ...
  fn run_verifier(
    ...
    use self::flatbuffers::Verifiable;
    v.visit_table(pos)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<SpriteSheet>>>>("sprites", Self::VT_SPRITES, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<AnimatedSprite>>>>("animated_sprites", Self::VT_ANIMATED_SPRITES, false)?
     .finish();
    Ok(())
  }
}
pub struct SpriteSheetRootArgs<'a> {
    pub sprites: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<SpriteSheet<'a>>>>>,
    pub animated_sprites: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<AnimatedSprite<'a>>>>>,
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> SpriteSheetRootBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_sprites(&mut self, sprites: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<SpriteSheet<'b >>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(SpriteSheetRoot::VT_SPRITES, sprites);
  }
  #[inline]
  pub fn add_animated_sprites(&mut self, animated_sprites: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<AnimatedSprite<'b >>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(SpriteSheetRoot::VT_ANIMATED_SPRITES, animated_sprites);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> SpriteSheetRootBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
pub fn root_as_sprite_sheet_root(buf: &[u8]) -> Result<SpriteSheetRoot, flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_sprite_sheet_root(buf: &[u8]) -> Result<SpriteSheetRoot, flatbuffers::InvalidFlatbuffer> {
...
#[inline]
pub fn finish_size_prefixed_sprite_sheet_root_buffer<'a, 'b, A: flatbuffers::Allocator + 'a>(fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>, root: flatbuffers::WIPOffset<SpriteSheetRoot<'a>>) {
